...
interface BlogEditorFormProps {
  ...
  onSaveDraft: () => void;
  onPublish: () => void;
  onUploadEditorImage: (file: File) => Promise<string>;
...
export default function BlogEditorForm({
  ...
  const updateField = <K extends keyof BlogEditorState>(field: K, nextValue: BlogEditorState[K]) => {
  ...
  return (
    <form className="space-y-6" onSubmit={(event) => event.preventDefault()}>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <RichTextEditor
              ...
              placeholder="Write the post body, add headings, embeds, and media..."
            />
          </div>
      ...
      <section className="card p-6">
        ...
        <div
          className="rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 p-5 transition-colors hover:border-primary-400 hover:bg-primary-50/40 dark:border-slate-700 dark:bg-slate-950/40 dark:hover:border-primary-500"
        ...
        >
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            />
            {value.coverImage && (
              <button type="button" className="btn-secondary inline-flex items-center gap-2" onClick={() => updateField('coverImage', '')}>
                <X className="h-4 w-4" />
                Remove
              </button>
            )}
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Defaults to excerpt or a generated snippet"
              maxLength={160}
            />
          </div>
        </div>
