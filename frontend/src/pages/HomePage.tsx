...
import type { BlogPost, SiteSetting } from '../types';
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {featuredBlogs.length > 0 && settings?.showFeaturedSection !== false && (
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {featuredBlogs.map((blog) => (
                <Link key={blog.id} to={`/blog/${blog.slug}`} className="card group overflow-hidden">
      ...
      {settings?.showLatestSection !== false && (
      ...
      {trendingBlogs.length > 0 && settings?.showTrendingSection !== false && (
        <section className="bg-white py-16 dark:bg-slate-950">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              {trendingBlogs.map((blog, index) => (
                <Link key={blog.id} to={`/blog/${blog.slug}`} className="card p-6 transition-shadow hover:shadow-lg">
      ...
      {settings?.showNewsletterSection !== false && (
      <section className="bg-gradient-to-br from-primary-700 to-sky-500 py-16 text-white">
