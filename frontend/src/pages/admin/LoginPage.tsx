...
export default function AdminLoginPage() {
  ...
  const handleSubmit = (event: FormEvent) => {
    void (async () => {
      ...
      try {
        ...
        const user = payload.user as CurrentUser;
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary-700 via-primary-600 to-sky-500 px-4 py-12 text-slate-900 dark:text-slate-100">
