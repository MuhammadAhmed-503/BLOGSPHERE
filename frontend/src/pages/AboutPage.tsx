      ...
      <div className="mx-auto mb-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            <div key={feature.title} className="card p-6 text-center transition-shadow hover:shadow-lg">
        ...
        <div className="card p-8">
          ...
          <div className="flex flex-wrap gap-3">
            {technologies.map((technology) => (
              <span key={technology} className="rounded-full bg-primary-100 px-4 py-2 font-medium text-primary-700 dark:bg-primary-900 dark:text-primary-300">
                {technology}
              </span>
            ))}
          </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="card p-8">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {['Dark Mode Support', 'Search & Filtering', 'Newsletter Signup', 'Responsive Layout', 'Related Posts', 'Social Sharing'].map((feature) => (
